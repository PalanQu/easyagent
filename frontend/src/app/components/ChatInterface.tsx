...
export const ChatInterface = React.memo<ChatInterfaceProps>(({ agentName }) => {
  ...
  const processedMessages = useMemo(() => {
    ...
    */
    const messageMap = new Map<
      string,
      { message: ChatMessageType; toolCalls: ToolCall[] }
    >();
  ...
  const actionRequestsMap: Map<string, ActionRequest> | null = useMemo(() => {
    ...
    const actionRequests = interruptValue && interruptValue["action_requests"];
  ...
  const reviewConfigsMap: Map<string, ReviewConfig> | null = useMemo(() => {
    const interruptValue = (interrupt as any)?.value;
    const reviewConfigs = interruptValue && interruptValue["review_configs"];
